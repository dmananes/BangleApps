  ...
  let writeLog = function () {
    ...
    try {
      ...
      if (entriesWritten % fr == 0) {
        ...
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'foregroundservice', action: 'local_broadcast', package: 'es.unileon.apptivate', extra: { location: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'foregroundservice', action: 'LOCAL_BROADCAST', package: 'es.unileon.apptivate', extra: { location: 'FROM BANGLE!!' } }))
        Bluetooth.println(
          JSON.stringify({ t: 'intent', target: 'foregroundservice', action: 'es.unileon.apptivate.bangle_broadcast', package: 'es.unileon.apptivate', extra: { message: 'FROM BANGLE!!' } })
        )
        Bluetooth.println(
          JSON.stringify({ t: 'intent', target: 'foregroundservice', action: 'es.unileon.apptivate.BANGLE_BROADCAST', package: 'es.unileon.apptivate', extra: { message: 'FROM BANGLE!!' } })
        )
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'foregroundservice', action: 'bangle_broadcast', package: 'es.unileon.apptivate', extra: { message: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'es.unileon.apptivate.local_broadcast', package: 'es.unileon.apptivate', extra: { location: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'es.unileon.apptivate.LOCAL_BROADCAST', package: 'es.unileon.apptivate', extra: { location: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'local_broadcast', package: 'es.unileon.apptivate', extra: { location: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'LOCAL_BROADCAST', package: 'es.unileon.apptivate', extra: { location: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'es.unileon.apptivate.bangle_broadcast', package: 'es.unileon.apptivate', extra: { message: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'es.unileon.apptivate.BANGLE_BROADCAST', package: 'es.unileon.apptivate', extra: { message: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'intent', target: 'action', action: 'bangle_broadcast', package: 'es.unileon.apptivate', extra: { message: 'FROM BANGLE!!' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'es.unileon.apptivate.local_broadcast', extra: { location: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'es.unileon.apptivate.LOCAL_broadcast', extra: { location: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'local_broadcast', extra: { location: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'LOCAL_BROADCAST', extra: { location: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'es.unileon.apptivate.bangle_broadcast', extra: { message: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'es.unileon.apptivate.BANGLE_BROADCAST', extra: { message: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'bangle_broadcast', extra: { message: 'asdfas' } }))
        Bluetooth.println(JSON.stringify({ t: 'int­ent', action: 'BANGLE_BROADCAST', extra: { message: 'asdfas' } }))
      }
